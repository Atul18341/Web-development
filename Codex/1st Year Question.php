...
$query="SELECT * FROM 1st_year_test_1_question";
...
echo"<div class='questions'>
     ...
     <b><u>Question-$t:</u></b><p id='ques'>{$view['QUESTIONS']}
...
$ANSWER=$_POST['Answer'];
$query="UPDATE 1st_year_test_1_question SET response_$ROLL_NO='$ANSWER' WHERE QUESTION_ID='$QUESTION_ID' ";
